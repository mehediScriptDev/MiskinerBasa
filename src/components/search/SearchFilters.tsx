import { SearchFilters as FilterType, DHAKA_AREAS } from '@/types/room';
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => updateFilter('roomType', value as FilterType['roomType'])}
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => updateFilter('genderPreference', value as FilterType['genderPreference'])}
          >
            <SelectTrigger>
