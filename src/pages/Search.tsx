...
import { SearchFilters as FilterType } from '@/types/room';
...
import { Search as SearchIcon, SlidersHorizontal, MapPin, Grid3X3, LayoutList } from 'lucide-react';
...
const Search = () => {
  ...
  const [filters, setFilters] = useState<FilterType>(() => {
    ...
    return {
      ...
      roomType: (searchParams.get('roomType') as FilterType['roomType']) || '',
      genderPreference: (searchParams.get('genderPreference') as FilterType['genderPreference']) || '',
